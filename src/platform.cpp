...
const std::unordered_map<SDL_Keycode, std::uint8_t> Platform::keymap{{SDLK_1, 0x01},
                                                                     {SDLK_2, 0x02},
                                                                     {SDLK_3, 0x03},
                                                                     {SDLK_4, 0x0C},
                                                                     {SDLK_q, 0x04},
  ...
  , texture{nullptr}
{
  ...
  texture = SDL_CreateTexture(
    renderer, SDL_PIXELFORMAT_RGB332, SDL_TEXTUREACCESS_STREAMING, view_width, view_height);
  if (!texture) {
